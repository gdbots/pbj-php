...
class MappingFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreate()
    {
        ...
        ksort($expected['pbj_test_type']['properties']);
        ksort($actual['pbj_test_type']['properties']);
        ...
        $expected = json_decode($expected, true);
        $actual = $mapping->toArray();
        ksort($expected['pbj_test_type']['dynamic_templates']);
        ksort($actual['pbj_test_type']['dynamic_templates']);
        $this->assertSame(json_encode($expected['pbj_test_type']['properties']), json_encode($actual['pbj_test_type']['properties']));
