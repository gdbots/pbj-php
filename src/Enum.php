...
/**
 * fixme: figure out how to maintain the flyweight enum when objects are serialized/unserialized
 * maybe types have write/read methods so we can store more data without using objects.
 *
